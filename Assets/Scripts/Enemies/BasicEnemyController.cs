...
// - playerTarget: Player Transform used for distance checks and chasing.
// - playerHealth: PlayerHealth attacked when in range.
// - patrolLeftPoint / patrolRightPoint: Manual patrol limits.
// - enemyAttackController: Component that owns attack cooldown and damage.
// - enemyHealth: Component that reports whether this enemy is dead.
...
{
    // Player transform assigned in the Inspector; this script does not search for it.
    ...
    // Current patrol destination, toggled between left and right points.
    private Transform currentPatrolTarget;

    // Current finite state for this simple enemy.
    private EnemyState currentState = EnemyState.Patrol;

    // Read-only state for debugging and future lightweight UI.
